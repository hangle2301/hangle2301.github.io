# Import file "Contacts-Prototype-R2-O2-T"
sketch = Framer.Importer.load("imported/Contacts-Prototype-R2-O2-T@1x")
...
sketch.nextBt.onClick ->
	window.location.href = 'https://hangle2301.github.io/contacts/Round-2/Option3-T.framer/index.html'		